...
>>>>>>> Stashed changes
        ...
        (async () => {
          ...
          const analyzeUrl = async (searchResult, index) => {
            ...
            for (let attempt = 1; attempt <= maxRetries; attempt++) {
              try {
                ...
                console.debug(
                    `[Grade-Able][SW] Analyzing URL ${index + 1}/${
                        results.length}`,
                    {
                    ...
                    issues: [
                      {
                        ...
                        message: `Failed to analyze after ${
                            maxRetries} attempts: ${err.message}`,
                        passed: 0,
                        total: 1,
                      },
                    ],
          ...
          const analysisPromises = results.map(
              (searchResult, index) => analyzeUrl(searchResult, index));
